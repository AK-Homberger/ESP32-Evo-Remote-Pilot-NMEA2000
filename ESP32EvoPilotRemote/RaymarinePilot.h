...
class RaymarinePilot {
  public:
    ...
    static void SetN2kPGN65288(tN2kMsg &N2kMsg, uint8_t destinationAddress, unsigned char AlarmState, unsigned char AlarmCode, unsigned char AlarmGroup);
    static inline void SetN2kAlarmState(tN2kMsg &N2kMsg, uint8_t destinationAddress, unsigned char AlarmState, unsigned char AlarmCode, unsigned char AlarmGroup) {
      return SetN2kPGN65288(N2kMsg, destinationAddress, AlarmState, AlarmCode, AlarmGroup);
    }

    static void SetN2kPGN65361(tN2kMsg &N2kMsg, uint8_t destinationAddress, unsigned char AlarmCode, unsigned char AlarmGroup);
    static inline void SetN2kSilenceAlarm(tN2kMsg &N2kMsg, uint8_t destinationAddress, unsigned char AlarmCode, unsigned char AlarmGroup) {
      return SetN2kPGN65361(N2kMsg, destinationAddress, AlarmCode, AlarmGroup);
    }
